...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['http://localhost:8000/auth/google', 'http://localhost:8000/auth/facebook'],
    'SERIALIZERS': {
        'user_create': 'authentication.serializers.SignUpSerializer',
        'user': 'authentication.serializers.SignUpSerializer',
        'current_user': 'authentication.serializers.SignUpSerializer',
