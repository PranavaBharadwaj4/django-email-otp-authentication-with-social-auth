...
from .views import FacebookAuthCallbackView,GoogleAuthCallbackView,ProfileViewSet,UserViewSet, signup,signupVerify,resendOtp,LoginView,two_step_otp_Verify,reset_password_send,reset_password_verify,reset_password,ChangePasswordView,set_pass_email,UsernameView,change_email_send,change_email_verify,Logout,CustomTokenRefreshView
...
urlpatterns = [
    path('google/', GoogleAuthCallbackView.as_view(), name='google_login'),
    path('facebook/', FacebookAuthCallbackView.as_view(), name='google_login'),
    ...
    path('two_step_otp_verify/',two_step_otp_Verify,name = "two_step_otp_Verify"),
